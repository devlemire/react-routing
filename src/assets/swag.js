export default [
  ...
  },
  {
    ...
    price: 10.00.toFixed(2),
    title: "DevMountain Beanie",
    description: "It's a beanie. You wear it on your head. 100% Acrylic with leather logo patch // One size fits all",
    promo: "Use code PROVOPICKUP for free shipping if you wish to pick up your hat in the Provo office."
  },
  {
    id: "0003",
    img: "https://images.bigcartel.com/product_images/154156375/2015-03-10_13.57.18.jpg?auto=format&fit=max&h=1000&w=1000",
    price: 12.00.toFixed(2),
    title: "DevMountain Tee",
    description: "This shirt is awesome. You are awesome. American Apparel Tee // Tri-Blend // (50% Polyester / 25% Ring-Spun Cotton / 25% Rayon)",
    promo: "Use code PROVOPICKUP for free shipping if you wish to pick up your hat in the Provo office."
  },
  {
    id: "0004",
